...
namespace Collektive.Unity.Example
{
    public class LineNeighborhoodVisualizer : NeighborhoodVisualizer
    {
        ...
        private Dictionary<Node, LineRenderer> _connections = new();

        protected override void OnSubscribe(Node node)
        {
        ...
        protected override void OnUnsubscribe(Node node)
        {
        ...
        private void UpdateConnectionPosition(LineRenderer lineRenderer, Node target)
        {
